...
// This based on SDL2-2.0.4/include/input/SDL_scancode.h with various
// rework (including removing SDL_ prefixes) and some such editing, but
// the actual codes should remain compatible.. because honestly the
// world doesn't need more ways to represent keys on the keyboard.
//
...
/**
 * Enumeration that matches the SDL_SCANCODE_ constants in SDL2-2.0.4
 * Note that most of the comments come from SDL and some of it might not apply.
 */
typedef enum
{
    SCANCODE_UNKNOWN = 0,
